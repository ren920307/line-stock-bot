...
- 所有價格後加「元」
- 全部劇本停損位統一，只有一個停損基準
- R:R 表示「獲得報酬÷承擔風險」，寫成「X:1」；R:R 3:1 = 報酬是風險的3倍
- R:R 閾值：回測劇本 ≥ 3:1，突破/追價/加碼劇本 ≥ 2:1
- 低於閾值但 > 1.5:1：寫「偏低，等更好位置，R:R X:1」
- ≤ 1.5:1 才寫「不建議，R:R僅X:1」，不展開劇本內容
- 每個區塊精簡，禁止長篇解釋
...
- 支撐位：必須低於現價，否則不得標為支撐
- 壓力位：必須高於現價，否則不得標為壓力
- BSL（Buy Side Liquidity）：近期明顯高點密集區，浮額與停損單聚集，必須高於現價；若今日收盤已突破該高點，代表掃單完成，需往上找下一個高點密集區作為新BSL
