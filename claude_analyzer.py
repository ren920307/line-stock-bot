...
【整體傾向】
▶R:R：現價XXX元進場，TP2 XXX元，停損XXX元，R:R約X:1
...
進場 XXX元　停損 XXX元　TP2 XXX元　R:R約X:1　有效 X日

②突破｜收盤突破XXX元，量大於1.5倍均量
停損A：XXX元（量比1.5x～2x）　R:R約X:1
停損B：突破K中點XXX元（量大於2x）　R:R約X:1　有效 X日
...
加碼價 XXX元　新停損上移至上次成本×0.97（最少距加碼價3%）　TP2 XXX元　R:R約X:1　有效 X日
