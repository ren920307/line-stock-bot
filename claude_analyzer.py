...
【今日數據】
MA排列：多頭/空頭/混亂，一句說明意義
量能：今日量是均量幾倍，放量/縮量/爆量，一句說明意義
位置：現價在費波哪個區間、距前高前低幾%

【SMC結構】
階段：積累/推進/派發/下跌（一句說明）
OB：XXX元～XXX元（推升前最後下跌K高低點）
FVG：XXX元～XXX元（若無跳空缺口則寫「無明顯FVG」）
BSL：XXX元（前高上方掃單目標）

【費波共振與關鍵位】
低點→高點：XXX元→XXX元
首選進場區：XXX元（費波X.XXX + OB/MA共振，說明共振原因）
次要支撐：XXX元（費波X.XXX，來源）
停損基準：跌破 XXX元 收盤出場
壓力：XXX元（來源）
TP1：XXX元（1.272）　TP2：XXX元（1.618）

【整體傾向與R:R】
現價進場R:R：(TP2-現價)÷(現價-停損) = X:1
若R:R < 1:3：現價不宜追，等回測至 XXX元
一句結論：偏多等回測 / 可追 / 觀望 / 偏空迴避
...
① 回測｜等回測 XXX元（費波+OB共振）止跌K確認
   進場 XXX元　停損 XXX元　TP1 XXX元　TP2 XXX元
   R:R = (TP2-進場)÷(進場-停損) = X:1　有效期 X 日

② 突破｜收盤突破 XXX元 且量 > 1.5倍均量
   停損A（標準）：跌破 XXX元，量比1.5x～2x用
   停損B（壓縮）：跌破突破K中點 XXX元，量比>2x才用
   R:R用A = (TP2-進場)÷(進場-停損A) = X:1
   R:R用B = (TP2-進場)÷(進場-停損B) = X:1　有效期 X 日

③ 追價｜BSL掃單完成、XXX元站穩才考慮
   進場 XXX元　停損 XXX元　TP1 XXX元　TP2 XXX元
   R:R = (TP2-進場)÷(進場-停損) = X:1　有效期 X 日
